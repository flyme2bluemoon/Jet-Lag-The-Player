...
export const seasonEighteenCards = {
    ...
    maine: {
        description: "Travel to within one kilometer of any lighthouse on Maine’s coast and stand at least 100 feet apart with the lighthouse in the shot. One teammate must communicate a five-letter word to the other using nothing but a light, in any way they wish. If the receiving teammate guesses incorrectly, travel to a different lighthouse before trying again.",
        id: "maine",
        label: "ME",
        name: "Maine",
        targets: ["Maine"],
        title: "Illuminate your teammate",
    },
    montana: { id: "montana", label: "MT", name: "Montana", targets: ["Montana"] },
    wyoming: { id: "wyoming", label: "WY", name: "Wyoming", targets: ["Wyoming"] },
    southCarolina: {
        description: "Get either a hole in one at a mini-golf course or a bogey at a real golf course. At any course, one player may try each hole once, and the team may swap players whenever they wish. If every hole is unsuccessful, try again at another course.",
        id: "south-carolina",
        label: "SC",
        name: "South Carolina",
        targets: ["South Carolina"],
        title: "Golf, either regular or mini",
    },
    kansas: { id: "kansas", label: "KS", name: "Kansas", targets: ["Kansas"] },
    rhodeIsland: { id: "rhode-island", label: "RI", name: "Rhode Island", targets: ["Rhode Island"] },
    margaritaville: {
        description: "Complete three rounds, one after each of three margaritas. In each round, one teammate randomly generates five times that it currently is somewhere in the world and reads them aloud; the other must name a city where it is currently that time. Get at least 5 of 15 correct without studying. Any restaurant in the Margaritaville family, such as LandShark Bar, qualifies.",
        id: "margaritaville",
    ...
    peopleMover: {
        id: "people-mover",
        label: "People Mover",
        name: "People Mover Wild Card",
        targets: ["Washington", "Nevada", "Michigan", "West Virginia", "Florida"],
        wildcard: true,
    },
...
const cardChanges: CardChange[] = [
    ...
    { episode: "finale", at: 2 * 60 + 47, location: "ben-adam", day: 5, add: ["peopleMover"] },
    { episode: "finale", at: 18 * 60, location: "public", add: ["utah"] },
    { episode: "finale", at: 18 * 60 + 12, location: "public", remove: ["wyoming"] },
    { episode: "finale", at: 18 * 60 + 22, location: "public", add: ["wisconsin"] },
    { episode: "finale", at: 34 * 60 + 25, location: "public", add: ["kansas"] },
    { episode: "finale", at: 34 * 60 + 41, location: "public", remove: ["kansas"] },
    { episode: "finale", at: 34 * 60 + 48, location: "public", add: ["northDakota"] },
];
...
const stateNeighbors = {
    ...
    Hawaii: [],
    Idaho: ["Canada", "Montana", "Nevada", "Oregon", "Utah", "Washington", "Wyoming"],
    ...
    Montana: ["Canada", "Idaho", "North Dakota", "South Dakota", "Wyoming"],
    ...
    "North Dakota": ["Canada", "Minnesota", "Montana", "South Dakota"],
    ...
    Washington: ["Canada", "Idaho", "Oregon"],
