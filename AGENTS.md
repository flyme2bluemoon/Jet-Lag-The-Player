...
- `useJapanGeoJson()` from `@/lib/japan-geojson` loads and caches Season 19's generated Japan ADM0 boundary. Use the hook instead of fetching the boundary independently; it returns `null` while loading.
